...
class SystemException(TException):
    ...
    def __init__(self, message=None,):
        super(SystemException, self).__setattr__('message', message)
...
class KVPairHinted(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('KVPairHinted')
        if self.key is not None:
            oprot.writeFieldBegin('key', TType.I32, 1)
            oprot.writeI32(self.key)
            oprot.writeFieldEnd()
...
class GetRet(object):
    ...
    def __init__(self, val=None, ret=None,):
        self.val = val
        self.ret = ret
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetRet')
        if self.val is not None:
            oprot.writeFieldBegin('val', TType.STRING, 1)
            oprot.writeString(self.val.encode('utf-8') if sys.version_info[0] == 2 else self.val)
            oprot.writeFieldEnd()
        if self.ret is not None:
            oprot.writeFieldBegin('ret', TType.BOOL, 2)
...
class GetRetTime(object):
    ...
    def __init__(self, val=None, ret=None, time=None,):
        self.val = val
        self.ret = ret
        self.time = time
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetRetTime')
        if self.val is not None:
            oprot.writeFieldBegin('val', TType.STRING, 1)
            oprot.writeString(self.val.encode('utf-8') if sys.version_info[0] == 2 else self.val)
            oprot.writeFieldEnd()
...
all_structs.append(KVPair)
KVPair.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'key', None, None, ),  # 1
    (2, TType.STRING, 'val', 'UTF8', None, ),  # 2
)
all_structs.append(KVPairHinted)
KVPairHinted.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'key', None, None, ),  # 1
    (2, TType.STRING, 'val', 'UTF8', None, ),  # 2
)
all_structs.append(GetRet)
GetRet.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'val', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'ret', None, None, ),  # 2
)
all_structs.append(GetRetTime)
GetRetTime.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'val', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'ret', None, None, ),  # 2
